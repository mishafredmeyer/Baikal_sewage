...
ppcp <- ppcp_orig %>%
  ...
  filter(Sample_ID %in% c("LI-1", "LI-2",  "LI-3", "BK-1", "BK-2", "BK-3",
                          "BGO-1", "BGO-2", "BGO-3", "KD-1", "KD-2", "EM-1",
                          "MS-1", "SM-1", "OS-1", "OS-2", "OS-3")) %>%
  group_by(Sample_ID) %>%
...
chlorophylla <- chla_orig %>%
  ...
  filter(Station %in% c("LI-1", "LI-2", "LI-3", "BK-1", "BK-2", "BK-3",
                        "BGO-1", "BGO-2", "BGO-3", "KD-1", "KD-2", "EM-1",
                        "MS-1", "SM-1", "OS-1", "OS-2", "OS-3")) %>%
  group_by(Station) %>%
